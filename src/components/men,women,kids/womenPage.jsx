            ...
            <div className="modalDescription-main">
              ...
              <div className="sneaker-description">
                ...
                <div className="modalDescription-sizes">
                  <strong>Size:</strong>
                  <div className="modalDescription-size">34</div>
                  <div className="modalDescription-size">35</div>
                  <div className="modalDescription-size">36</div>
                  <div className="modalDescription-size">37</div>
