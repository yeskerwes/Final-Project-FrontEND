...
import FeedBackSection from '../faq/feedbackSection';
import Warranty from '../faq/warranty';
import Product from '../faq/product';
    ...
    <div className="personal-account">
      ...
      <div className="top-up-section">
        ...
        <div className="preset-amounts">
          <button onClick={() => handlePresetAmount(100)} className="amount-btn">100 $</button>
          <button onClick={() => handlePresetAmount(200)} className="amount-btn">200 $</button>
          <button onClick={() => handlePresetAmount(500)} className="amount-btn">500 $</button>
          <button onClick={() => handlePresetAmount(1000)} className="amount-btn">1000 $</button>
          <button onClick={() => handlePresetAmount(5000)} className="amount-btn">5000 $</button>
        </div>
      ...
      <div className="confirmation">
        <button onClick={handleAddAmount}>Accept</button>
      </div>
    </div>
  );
}
...
function ProfilePage() {
  ...
  const items = [
    { title: 'Current Orders', description: 'View your current orders.', icon: <CurrentOrder />, link: '/orderPage' },
    ...
    { title: 'Basket', description: 'Look at the contents of your shopping cart.', icon: <Basket />, link: '/cartPage' },
